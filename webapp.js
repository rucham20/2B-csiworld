...
function next(x) {
	...
	case 1:
		...
		document.getElementById("choice1").innerHTML = "<input id= 'choice1' type='button' onClick='next(2)' value='Walk towards the body'>";
		document.getElementById("choice2").innerHTML = "<input id='choice2' type='button'  onClick='next(2)' value='Call your colleagues'>";
	...
	case 2:
		...
		document.getElementById("choice1").innerHTML = "<input id= 'choice1'  type='button' onClick='next(1)' value=' '>";
